...
public class YCatController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 점프한다.
        if (Input.GetKeyDown(KeyCode.W) && m_rigid2DCat.linearVelocity.y == 0)
        {
    ...
    public void YNnockBack()
    {
        // AddForce로 물리적 힘을 가하고 ForceMode2D안에 있는 Impulse로 즉발적인 반응을 만듬.
        this.m_rigid2DCat.AddForce(-transform.localScale * this.fKnockBack, ForceMode2D.Impulse);
    }
}
